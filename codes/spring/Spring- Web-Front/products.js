function LoadProducts(){
    ...
    xml.onload=function(){
        ...
        for(let i=0;i<array.length;i++){
            ...
            tbodyValue+="<td> <button class='btn btn-primary' onclick='openEditPage("+p.id+")'>Editor";
            tbodyValue+=" </button> <button class='btn btn-danger' onclick='deleteProduct("+p.id+")'>Delete</button></td></tr>";
